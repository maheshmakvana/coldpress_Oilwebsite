      ...
      <Card className="card-hover flex h-full flex-col overflow-hidden">
        <div className="relative aspect-[4/5] w-full overflow-hidden bg-muted">
          ...
          <div className="absolute left-4 top-4 flex flex-col gap-2 text-xs">
            <Badge className="bg-secondary/90 text-secondary-foreground">Cold-Pressed</Badge>
            <Badge variant="accent" className="bg-primary/85 text-primary-foreground">
              Lab Tested
            </Badge>
          </div>
        </div>
        ...
        <CardContent>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {product.certifications.map((cert) => (
              <Badge key={cert} variant="outline" className="border-primary/30 text-xs">
                {cert}
              </Badge>
            ))}
          </div>
